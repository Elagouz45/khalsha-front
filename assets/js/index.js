...
function addContainer41() {
    const newForm = document.createElement("form");
    const newRow = document.createElement("div");
    newRow.classList.add("row", "fs-14", "position-relative");

    for (let i = 0; i < 12; i++) {
        const newCol = document.createElement("div");
        if (i === 1) {
            newCol.classList.add("col-sm-8", "position-relative");
            const newLabel1 = document.createElement("label");
            newLabel1.textContent = " وصف البضاعة ";
            newLabel1.classList.add("text-bold-gray", "d-block");
            const newselect1 = document.createElement("select");
            const newoption = document.createElement("option");
            newselect1.classList.add("fs-14", "text-center", "w-100");
            newoption.setAttribute("value", "");
            ...
            newCol.classList.add("col-sm-4", "position-relative");
            const newLabel2 = document.createElement("label");
            newLabel2.textContent = "أضف صورة";
            newLabel2.classList.add("text-bold-gray", "d-block");
            const newLabel3 = document.createElement("label");
            ...
            newCol.classList.add("col-12", "d-flex", "justify-content-between", "type");
            const div1 = document.createElement('div')
            newCol.appendChild(div1)

            const newLabel1 = document.createElement("label");
            newLabel1.textContent = "كرتون";
            newLabel1.classList.add("text-bold-gray")

            const newInput1 = document.createElement("input");
            newInput1.setAttribute("type", "radio");

            newInput1.setAttribute("name", `type${i}`);
            newInput1.setAttribute("id", `cartoon${i}`);
            newLabel1.setAttribute("for", `cartoon${i}`);

            div1.appendChild(newInput1);
            div1.appendChild(newLabel1);

            const div2 = document.createElement('div')
            newCol.appendChild(div2)

            const newLabel2 = document.createElement("label");
            newLabel2.textContent = "طبلية";
            newLabel2.classList.add("text-bold-gray")

            const newInput2 = document.createElement("input");
            newInput2.setAttribute("type", "radio");

            newInput2.setAttribute("name", `type${i}`);
            newInput2.setAttribute("id", `cartoon${i}`);
            newLabel2.setAttribute("for", `cartoon${i}`);
            ...
            newCol.classList.add("col-sm-6", "pe-0");
            ...
            newInput45.classList.add("w-100", "text-center", "fs-14");
            newLabel3.textContent = "الكمية";
            newLabel3.classList.add("text-bold-gray", "d-block")
            newInput45.setAttribute("type", "number");
            newInput45.value = 0
            ...
            newCol.classList.add("col-sm-6", "ps-0");

            const newLabel3 = document.createElement("label");
            const newInput45 = document.createElement("input");
            const div = document.createElement("div");
            div.classList.add("position-relative", "me-auto");
            newInput45.classList.add("w-100", "text-center", "fs-14");
            newLabel3.textContent = "الوزن";
            newLabel3.classList.add("text-bold-gray", "d-block")
            newInput45.setAttribute("type", "number");
            ...
            newCol.classList.add("col-12", "px-0");
            const p = document.createElement("p");
            p.classList.add("text-bold-gray", "mb-1");
            p.textContent = 'أبعاد الشحنة ( طول - عرض - إرتفاع ) بالسم'
            ...
            for (let index = 0; index < 3; index++) {
                if (index === 0) {
                    ...
                    newInput.classList.add("w-100", "fs-14", "text-center");
                    newInput.setAttribute("placeholder", `الطول`);
                    ...
                    newInput.setAttribute("type", "number");
                    newInput.classList.add("w-100", "fs-14", "text-center");
                    newInput.setAttribute("placeholder", `العرض`);
                    ...
                    newInput.setAttribute("type", "number");
                    newInput.classList.add("w-100", "fs-14", "text-center");
                    newInput.setAttribute("placeholder", `الارتفاع`);
            ...
            const div = document.createElement("div");
            div.classList.add("amount", "mx-auto", "position-relative");
            ...
            newInput45.classList.add("w-100", "text-center", "fs-14");
            newLabel3.textContent = "الكمية";
            newLabel3.classList.add("text-bold-gray", "d-block", "text-center")
            newInput45.setAttribute("type", "number");
            ...
            const newLabel1 = document.createElement("label");
            newLabel1.textContent = "الحجم";
            newLabel1.classList.add("text-bold-gray");
            const newInput1 = document.createElement("input");
            newInput1.setAttribute("type", "text");
            newInput1.classList.add("w-100", "text-center", "fs-14");
            div1.appendChild(newLabel1);
            div1.appendChild(newInput1);
            ...
            newCol.classList.add("position-absolute", "fs-14", "add-button", "pointer-event", "addFormButton");
            newCol.textContent = '  اضافة طرد اخر';
